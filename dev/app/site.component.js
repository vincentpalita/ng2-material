...
var SiteAppComponent = (function () {
    function SiteAppComponent(http, navigation, media, cdr, router, zone, _components) {
        this.http = http;
    ...
    SiteAppComponent.prototype.ngOnDestroy = function () {
    ...
    SiteAppComponent = __decorate([
        core_1.Component({
            ...
            directives: [
                router_1.ROUTER_DIRECTIVES, ng2_material_1.MATERIAL_DIRECTIVES, sidenav_1.MD_SIDENAV_DIRECTIVES, icon_1.MdIcon, toolbar_1.MdToolbar,
        ...
        __metadata('design:paramtypes', [http_1.Http, navigation_service_1.NavigationService, ng2_material_1.Media, core_1.ChangeDetectorRef, router_1.Router, core_1.NgZone, components_service_1.ComponentsService])
    ], SiteAppComponent);
