...
testing_1.describe('Component: Components', function () {
    var builder;
    testing_1.beforeEachProviders(function () { return [components_component_1.ComponentsComponent]; });
    testing_1.beforeEach(testing_1.inject([testing_2.TestComponentBuilder], function (tcb) { builder = tcb; }));
    testing_1.it('should inject the component', testing_1.inject([components_component_1.ComponentsComponent], function (component) {
