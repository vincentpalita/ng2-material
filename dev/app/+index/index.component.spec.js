...
testing_1.describe('Component: Index', function () {
    var builder;
    testing_1.beforeEachProviders(function () { return [index_component_1.IndexComponent]; });
    testing_1.beforeEach(testing_1.inject([testing_2.TestComponentBuilder], function (tcb) { builder = tcb; }));
    testing_1.it('should inject the component', testing_1.inject([index_component_1.IndexComponent], function (component) { testing_1.expect(component).toBeTruthy(); }));
