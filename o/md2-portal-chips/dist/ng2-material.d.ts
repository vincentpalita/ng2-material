...
declare module 'ng2-material/components/chips/chip_remove' {
...
declare module 'ng2-material/components/chips/chip_content' {
	import { TemplateRef } from "angular2/core";
	import { TemplatePortalDirective } from "@angular2-material/core";
...
declare module 'ng2-material/components/chips/chip' {
	import { MdChips, IMdChipData } from 'ng2-material/components/chips/chips';
	import { TemplatePortalDirective } from "@angular2-material/core";
	export class MdChip {
	    private chips;
	    constructor(chips: MdChips);
	    chipTemplate: TemplatePortalDirective;
	    removeTemplate: TemplatePortalDirective;
	    private viewChip;
	    private viewRemove;
	    private contentChip;
...
declare module 'ng2-material/components/chips/chip_input' {
	...
	export class MdChipInput {
	    ...
	    private chips;
	    private input;
	    constructor(elementRef: ElementRef, chips: MdChips);
	    focus(): void;
...
declare module 'ng2-material/core/util/uuid' {
	export function uuid(): string;

}
declare module 'ng2-material/components/chips/chips' {
	import { ChangeDetectorRef, ApplicationRef } from "angular2/core";
	import { MdChipInput } from 'ng2-material/components/chips/chip_input';
	...
	export class MdChips {
	    ...
	    app: ApplicationRef;
	    constructor(cdr: ChangeDetectorRef, app: ApplicationRef);
	    input: MdChipInput;
	    focusInput(): void;
	    /** Collection of chip values over time */
	    collection$: Subject<IMdChipData[]>;
	    collection: IMdChipData[];
	    private _collection;
...
declare module 'ng2-material/components/data_table/data_table_selectable_tr' {
...
declare module 'ng2-material/components/data_table/data_table' {
	import { EventEmitter, QueryList, AfterContentInit } from 'angular2/core';
	import { MdDataTableHeaderSelectableRow, MdDataTableSelectableRow, ITableSelectableRowSelectionChange } from 'ng2-material/components/data_table/data_table_selectable_tr';
	export * from 'ng2-material/components/data_table/data_table_selectable_tr';
	/**
	 * Selectable change event data
	 */
...
declare module 'ng2-material/core/util/viewport' {
	/**
	...
	export class NodeViewportHelper extends ViewportHelper {
	    getDocumentNativeElement(): any;
	    requestFrame(fn: (elapsed?: number) => any): any;
	    matchMedia(query: string): ViewportMediaMatch;
	    scrollTop(): number;
	}
...
declare module 'ng2-material/components/peekaboo/peekaboo' {
	import { OnDestroy, ApplicationRef } from "angular2/core";
...
declare module 'ng2-material/all' {
	...
	export * from 'ng2-material/components/chips/chips';
	export * from 'ng2-material/components/content/content';
	export * from 'ng2-material/components/data_table/data_table';
	...
	export * from 'ng2-material/core/util/viewport';
