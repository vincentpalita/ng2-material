...
var TabsDynamicTabsComponent = (function () {
    function TabsDynamicTabsComponent() {
        this.tabs = [
    ...
    Object.defineProperty(TabsDynamicTabsComponent.prototype, "selectedIndex", {
        get: function () {
    ...
    TabsDynamicTabsComponent.prototype.addTab = function (title, view) {
        view = view || title + ' Content View';
        this.tabs.push({ title: title, content: view, disabled: false });
    };
    TabsDynamicTabsComponent.prototype.removeTab = function (tab) {
    ...
    ], TabsDynamicTabsComponent.prototype, "selectedIndex", null);
    TabsDynamicTabsComponent = __decorate([
        core_1.Component({
            moduleId: module.id,
            ...
            directives: [ng2_material_1.MATERIAL_DIRECTIVES, tabs_1.MD_TABS_DIRECTIVES, input_1.MD_INPUT_DIRECTIVES]
        }), 
        __metadata('design:paramtypes', [])
    ], TabsDynamicTabsComponent);
    return TabsDynamicTabsComponent;
}());
exports.TabsDynamicTabsComponent = TabsDynamicTabsComponent;
//# sourceMappingURL=tabs-dynamic-tabs.component.js.map