...
function main() {
    ...
    testing_1.describe('Data table', function () {
        ...
        testing_1.describe('_unsubscribeChildren', function () {
            testing_1.it('should reset the selected values', testing_1.async(testing_1.inject([], function () {
                return setup().then(function (api) {
            ...
            testing_1.it('should unsubscribe to listener', testing_1.async(testing_1.inject([], function () {
                return setup().then(function (api) {
                    ...
                    testing_1.expect(spy.calls.count()).toEqual(1);
                });
            })));
        });
        testing_1.describe('_updateChildrenListener', function () {
            testing_1.it('should ask unsubscription', testing_1.async(testing_1.inject([], function () {
                return setup().then(function (api) {
                    spyOn(api.comp, '_unsubscribeChildren');
                    api.comp._updateChildrenListener(api.comp._rows);
                    testing_1.expect(api.comp._unsubscribeChildren).toHaveBeenCalled();
                });
            })));
        });
    });
